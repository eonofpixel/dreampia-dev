...
async function inspectWorkspaceContext(raw: unknown): Promise<RepoContextSummary> {
...
async function runSafeWorkspaceCommand(raw: unknown): Promise<CommandRunResult> {
